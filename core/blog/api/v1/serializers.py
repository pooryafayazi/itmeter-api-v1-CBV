...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ['id','image','image_url','author','name','email','title','topic','snippet','content','tags','category','counted_views','status','login_require','relative_url','absolute_api_url','published_date']
